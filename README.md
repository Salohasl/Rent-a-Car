...
<a href="https://mix-rent.ru/">https://mix-rent.ru/</a>📎

---

<h2>What's in this project:</h2>
<ol>
  <li>Upload from JSON</li>
  <li>WP integration</li>
  <li>Optimization and compression</li>
  <li>Another satisfied customer</li>
</ol>
